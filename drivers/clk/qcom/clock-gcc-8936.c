...
static struct clk_freq_tbl ftbl_gcc_oxili_gfx3d_clk[] = {
	F(  19200000,	   gpll3_out_main,   1,	  0,	0),
	F(  50000000,	   gpll0_out_main,  16,	  0,	0),
	F(  80000000,      gpll0_out_main,  10,	  0,	0),
	F( 100000000,      gpll3_out_main,   8,	  0,	0),
	F( 160000000,      gpll0_out_main,   5,	  0,	0),
	F( 192000000,      gpll3_out_main,   4,	  0,	0),
	F( 200000000,      gpll0_out_main,   4,	  0,	0),
	F( 220000000,      gpll0_out_main,   5,	  0,	0),
	F( 260000000,      gpll3_out_main,   3,	  0,	0),
	F( 300000000, 	   gpll0_out_main,   2,    0,    0),
	F( 310000000,	   gpll2_gfx3d,	     3,	  0,	0),
	F( 415000000,	   gpll2_gfx3d,   2,	  0,	0),
	F( 455000000,      gpll3_out_main,   2,	  0,	0),
	F( 475000000,      gpll2_gfx3d,   2,    0,    0),
	F( 550000000,      gpll3_out_main,   2,    0,    0),
	F( 575000000,      gpll2_gfx3d,   2,    0,    0),
	F( 600000000,      gpll3_out_main,   2,   0,    0),
	F( 650000000,      gpll2_gfx3d,   2,    0,    0),
	F( 700000000, 	   gpll2_gfx3d,   2,    0,    0),
	F( 720000000, 	   gpll3_out_main,   2,    0,    0),
	F_END
};
...
static struct rcg_clk gfx3d_clk_src = {
	...
	.c = {
		...
		.ops = &clk_ops_rcg,
		VDD_DIG_FMAX_MAP4(LOW, 100000000, NOMINAL, 455000000, NOMINAL_PLUS, 550000000, HIGH,
			720000000),
