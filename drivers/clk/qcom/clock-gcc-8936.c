...
static struct clk_freq_tbl ftbl_gcc_oxili_gfx3d_clk[] = {
	...
	F( 200000000,      gpll3_out_main,   4,	  0,	0),
	F( 220000000,      gpll3_out_main,   5,	  0,	0),
	F( 266670000,      gpll0_out_main,   3,	  0,	0),
	F( 310000000,	gpll2_gfx3d,	3,	  0,	0),
	F( 415000000,	   gpll3_out_main,   2,	  0,	0),
	F( 435000000,      gpll0_out_main,   2,	  0,	0),
	F( 465000000,      gpll3_out_main,   2,    0,    0),
	F( 515000000,      gpll0_out_main,   2,    0,    0),
...
static struct rcg_clk gfx3d_clk_src = {
	...
	.c = {
		...
		.ops = &clk_ops_rcg,
		VDD_DIG_FMAX_MAP4(LOW, 200000000, NOMINAL, 415000000, NOMINAL_PLUS, 650000000, HIGH,
			700000000),
